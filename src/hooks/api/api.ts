...
import {DataContentProps, RequirementSubmitProps, RowModalDiscount} from "@/contexts/generateTariff/interfaces";
import {selectionRange} from "@/contexts/generateTariff/functions/handleForm";
